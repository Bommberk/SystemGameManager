# System & Game Manager – Changelog (v0.5.8 → v0.5.9)
...
- **Environment Handling:** Implemented conditional logic in startup flow; system info loading is now skipped exclusively for production builds where applicable, streamlining performance on initial launch.
...
- **New Icons:** Integrated the vertical ellipsis icon into project assets (`assets/icons/ellipsis-vertical-solid-full.svg`) to trigger contextual menus.
